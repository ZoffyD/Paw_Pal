...
(user_id, pet_name, age, gender, pet_type, category, health ,description, image_paths, lat, lng) 
VALUES 
('$user_id', '$pet_name', '$age','$gender','$pet_type', '$category','$health','$description', '', '$lat', '$lng')";
